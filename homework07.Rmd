...
The length that was removed is equal to the sum $1/2 + 1/4 + 1/8 + ... $, which by the geometric series is equal to $\frac{1/2}{1-1/2} = 1$. This means that the total length that was not included in the intersection is equal to 1. Therefore $F$ is nonempty. 
\end{solution}
